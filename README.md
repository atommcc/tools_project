...
สามารถนำข้อมูลชุดนี้และข้อมูลย้อนหลังเพื่อดู pattern แล้วสร้างโมเดลเพื่อทำนายผลการแพ้และชนะ และวางกลยุทธ์ที่เหมาะสมได้
	- ทีมที่มีโอกาสชนะ
	- ผู้เล่นที่อยู่ทีมไหนก็ชนะ
	- กลยุทธ์ที่เหมาะสมในการตัดสินใจทำ Pitstop ในแต่ละสนาม 
	- performace ในการทำ pitstop โดยเปรียบเทียบค่าเฉลี่ยของระยะเวลาในการทำ Pitstop 
